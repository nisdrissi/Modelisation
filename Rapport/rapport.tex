\documentclass[a4paper, title]{report}
\usepackage{geometry}
...
vignoble de Suresnes}      % renseigne le titre
\author{Zakaria Ait-Omar, Clémentine Chasles, Nisrine Drissi} 
\date{14 janvier 2016}     %   "   "   la future date de parution

\usepackage{titlesec}
\titleformat{\chapter}[hang]{\bf\huge}{\thechapter}{2pc}{} 
\titleformat{\part}[display]{\normalfont\huge\bfseries\centering}{\partname}
...
%\part*{STRUCTURATION ET MODÉLISATION D'UN SYSTÈME D'INFORMATION : Le
%vignoble de Suresnes}\label{structuration-et-modelisation-dun-systeme-%dinformation-le-vignoble-de-suresnes}

%\begin{figure}
%\includegraphics*[widht=4cm, height=3cm]{Images/ensg.jpg}
%\end{figure}
...
\subsection{L'environnement de travail}\label{lenvironnement-de-travail}
...
\section{Conception de la solution}\label{conception-de-la-solution}
...
\subsection{Grands choix techniques}\label{grands-choix-techniques}
...
\begin{figure}
\centering
\includegraphics{Images/DiagrammeClasse.jpg}
...
\subsubsection{L'utilisateur}\label{utilisateur}
...
\subsubsection{L'administrateur}\label{administrateur}
...
\subsubsection{Le vigneron}\label{vigneron}
...
\section{Limites et contraintes d'utilisation}\label{limites-et-contraintes-dutilisation}
...
\subsection{Le passage à l'informatique}\label{le-passage-a-linformatique}
...
\subsection{La multiplicité des rôles}\label{la-multiplicite-des-roles}
